    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="selected">
                        <a href="index.html"></i>Pengumuman</a>
                    </li>
        ...
        <div id="page-wrapper">
            ...
            <form action= "" method="post">
                ...
                <input class="form-control" type="text" name="judul" value="<?=$judul_awal; ?>">
                
                <textarea name="konten"><?=$konten_awal; ?></textarea>
                <script>
