...
<article class="module width_full">
	<header><h3>Data Siswa | <a href="?p=daftar_form&mod=add"> Tambah Data</a></h3></header>
	<div class="module_content">
	<form action="?p=daftar_form" method="post" name="form_daftar">
...
<article class="module width_full">
	<header><h3>Data Nilai </h3></header>
	<div class="module_content">
	<table class="tbl_form">
		<?php
